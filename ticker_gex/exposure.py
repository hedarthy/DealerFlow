"""Dealer-positioning greeks and exposure profiles (vendored for the ticker alert).
...
the normal CDF/PDF come from ``math``. Kept independent of the rest of the repo so this
on-demand alert can never be broken by, or break, the other pipelines.
...
def select_window_strikes(strikes, spot, n=25):
    ...
    exists. Used by the heatmaps to show "25 up / 25 down".
    """
